#contact danielle.arsenault@uconn.edu for any questions :)
...
#using acc_list list of genome accessions used in annotation lines of these files:
#report on 1. which genomes were underrepresented for each gene (since we expect at least one from each genome) (genome_rep_results.txt)
...
#acc_list: list, hardcoded list of genome accessions. you caould add a bit that reads a txt file but my list is constant and small enough that I just hardcoded.
